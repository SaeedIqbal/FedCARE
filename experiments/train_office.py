import torch
from data.office import OfficeLoader
...
def train_office(args):
    ...
    # Training logic
    loader = OfficeLoader(root="/home/phd/Datasets/Office")
    ...
    torch.save(model.state_dict(), "checkpoints/office_fedcare.pth")
